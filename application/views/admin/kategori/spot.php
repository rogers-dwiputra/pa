	...
	<div class="span9">
		...
		<table class="table table-hover">
			...
			<tr>
				...
				<td>
					<a data-toggle="modal" data-target="#modal-view" href="<?php echo site_url('admin/kategori_spot/view/'.$key['id_kategori_spot']); ?>" class="btn btn-info">View</a></td>
...
<div id="modal-tambah" class="modal hide fade">
  ...
  <div class="modal-body">
    <form class="form-horizontal" method="POST" action="<?php echo site_url('admin/kategori_event/insert'); ?>">
		    ...
		    <label class="control-label" for="kategori_event">Kategori Spot</label>
		    <div class="controls">

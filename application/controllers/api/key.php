...
class Key extends REST_Controller
{
	...
	{
		return $this->db->where('api_key', $key)->get(config_item('rest_keys_table'))->row();
	}
	...
	{
		return $this->db->where('api_key', $key)->count_all_results(config_item('rest_keys_table')) > 0;
	}
	...
	{
		return $this->db->where('api_key', $key)->update(config_item('rest_keys_table'), $data);
	}
	...
	{
		return $this->db->where('api_key', $key)->delete(config_item('rest_keys_table'));
	}
}
